  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white w-full h-full md:w-[90vw] md:h-[90vh] lg:w-[80vw] lg:h-[85vh] md:rounded-2xl flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between p-4 md:p-6 border-b bg-soft-green md:rounded-t-2xl flex-shrink-0">
          <div className="flex items-center">
            ...
            <div className="flex items-center">
              <Shield className="w-6 h-6 md:w-8 md:h-8 text-primary mr-3" />
              <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-dark">Integritetspolicy</h1>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
          <div className="max-w-4xl mx-auto space-y-8">
            {/* Introduction */}
            <section className="bg-light-green rounded-2xl p-6 md:p-8 border border-soft-green">
              <div className="flex items-center mb-4">
                <Eye className="w-6 h-6 text-primary mr-3" />
                <h2 className="text-xl md:text-2xl font-bold text-dark">Översikt</h2>
              </div>
            ...
            {/* Contact Information */}
            <section className="bg-gradient-to-r from-dark to-gray-800 rounded-2xl p-6 md:p-8 text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-semibold text-primary mb-4">Dataskyddsombud</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-primary mb-4">Tillsynsmyndighet</h3>
