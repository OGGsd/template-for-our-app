      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          <div className="order-1 space-y-6 md:space-y-8">
            <div className="bg-white rounded-2xl p-6 md:p-8 border border-soft-green">
              <h2 className="text-xl md:text-2xl font-bold text-dark mb-4 md:mb-6 text-center md:text-left">Kontaktinformation</h2>
              
              <div className="space-y-4 md:space-y-6">
                <div className="flex flex-col md:flex-row items-center md:items-start text-center md:text-left">
                  <div className="bg-primary rounded-full p-2 md:p-3 mb-3 md:mb-0 md:mr-4 flex-shrink-0">
                    <MapPin className="w-5 h-5 md:w-6 md:h-6 text-white" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <h3 className="font-semibold text-dark mb-1">Adress</h3>
                    <p className="text-tertiary text-sm md:text-base">Barnarpsgatan 3<br />553 16 Jönköping</p>
                    <button 
                      onClick={openMaps}
                      className="text-primary hover:text-secondary font-medium mt-2 flex items-center justify-center md:justify-start text-sm md:text-base"
                    >
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start text-center md:text-left">
                  ...
                  <div>
                    ...
                    <button 
                      onClick={callPhone}
                      className="text-tertiary hover:text-primary transition-colors text-sm md:text-base"
                    >
                      036-712 300
                    </button>
                  </div>
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start text-center md:text-left">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <button 
                      onClick={sendEmail}
                      className="text-tertiary hover:text-primary transition-colors text-sm md:text-base break-all"
                    >
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start text-center md:text-left">
                  ...
                  <div>
                    ...
                    <div className="text-tertiary space-y-1 text-sm md:text-base">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button 
                ...
                className="bg-dark hover:bg-gray-800 text-white p-4 md:p-6 rounded-xl font-semibold transition-colors duration-300 text-sm md:text-base"
              >
                Boka Tid Online
              </button>
              <button 
                onClick={callPhone}
                className="bg-primary hover:bg-secondary text-white p-4 md:p-6 rounded-xl font-semibold transition-colors duration-300 text-sm md:text-base"
              >
                Ring Oss Nu
              </button>
            </div>
          ...
          <div className="order-2 bg-white rounded-2xl p-6 md:p-8 border border-soft-green">
            <h2 className="text-xl md:text-2xl font-bold text-dark mb-4 md:mb-6 text-center md:text-left">Hitta Till Oss</h2>
            <div className="bg-soft-green rounded-xl h-64 md:h-96 flex items-center justify-center">
              <div className="text-center text-tertiary px-4">
                ...
                <p className="text-xs md:text-sm text-tertiary mb-4">Centralt beläget i Jönköping centrum</p>
                <button 
                  onClick={openMaps}
                  className="mt-4 bg-primary text-white px-4 md:px-6 py-2 md:py-3 rounded-lg hover:bg-secondary transition-colors duration-300 text-sm md:text-base"
                >
                  Öppna i Google Maps
                </button>
              </div>
            ...
            <div className="mt-4 md:mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              <div className="bg-soft-green p-3 md:p-4 rounded-lg text-center">
